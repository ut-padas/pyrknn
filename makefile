...
prknn/kernels/gpu/impl/obj/primitives.o:
	nvcc -shared -c prknn/kernels/gpu/impl/primitives.cu -o prknn/kernels/gpu/impl/obj/primitives.o --expt-extended-lambda -Xcudafe --diag_suppress=esa_on_defaulted_function_ignored -Xcompiler -O3,-fPIC
