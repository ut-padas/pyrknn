...
for k in range(1):
    ...
    if 1:
        ...
        print(1)
        knndis_np = cp.asnumpy(knndis.ravel())
        print(1)
        knnidx_np = cp.asnumpy(knnidx.ravel())
        print(1)
        ''' 
        ...
        py_gpuknn(indptr_np, indices_np, data_np, gids_np, \
                             tot_pt, leaves, \
                             K, knndis_np, knnidx_np, \
                             maxnnz)
