...
object_list=["filknn/dense/dfiknn.o", "filknn/sparse/sfiknn.o"]
...
print(extensions)
extNames = scandir("filknn/sparse")
print(extNames)
extensions += [makeExtension(name) for name in extNames]
...
setup(
    name="filknn",
    packages=["filknn", "filknn/dense", "filknn/sparse", "filknn/tree", "filknn/utils"],
