...
def py_queryleafknn(data_ref, data_q, leaves, ppl, k, knndis, knnidx, deviceId, verbose, morId_q, gid_leaves, n_iter):
 
  
  assert(n_iter == 1, 'more than one iteration per kernerl invocation')
