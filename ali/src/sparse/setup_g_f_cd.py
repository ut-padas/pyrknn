...
object_list=["guided_full_copydata/Norms.o", "guided_full_copydata/merge.o", \
            "guided_full_copydata/GuidedBinSearch.o", "guided_full_copydata/queryknn_guided.o"]
...
extNames = scandir("guided_full_copydata")
print(extNames)
