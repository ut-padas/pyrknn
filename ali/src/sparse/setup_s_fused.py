...
object_list=["seqsearch_fused/Norms.o", "seqsearch_fused/SeqBinSearch.o", "seqsearch_fused/queryknn_seqsearch.o", \
            "seqsearch_fused/merge.o"]
...
extNames = scandir("seqsearch_fused")
print(extNames)
