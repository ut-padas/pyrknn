...
object_list=["full_single_perm/norm.o", "full_single_perm/dist_full_single.o", "full_single_perm/queryleafknn.o", \
            "full_single_perm/merge.o"]
...
extNames = scandir("full_single_perm")
print(extNames)
